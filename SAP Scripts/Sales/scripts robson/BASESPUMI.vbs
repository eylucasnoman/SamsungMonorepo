...
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "C:\Users\seda.scm31\Desktop\VALIDAÇÃO DE PEDIDOS\PUMI\Bases Condição de Pagamento\Division 10 - TV ; AV; REF; WM; AC; SAC; VC"
...
session.findById("wnd[0]/usr/cntlG_CUSTOM_CONTAINER/shellcont/shell").pressToolbarContextButton "&MB_EXPORT"
session.findById("wnd[0]/usr/cntlG_CUSTOM_CONTAINER/shellcont/shell").selectContextMenuItem "&XXL"
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "C:\Users\seda.scm31\Desktop\VALIDAÇÃO DE PEDIDOS\PUMI\Bases Condição de Pagamento\Division 42 - MON"
...
session.findById("wnd[0]/usr/cntlG_CUSTOM_CONTAINER/shellcont/shell").pressToolbarContextButton "&MB_EXPORT"
session.findById("wnd[0]/usr/cntlG_CUSTOM_CONTAINER/shellcont/shell").selectContextMenuItem "&XXL"
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "C:\Users\seda.scm31\Desktop\VALIDAÇÃO DE PEDIDOS\PUMI\Bases Condição de Pagamento\Division 43 - NPC"
...
session.findById("wnd[0]/usr/cntlG_CUSTOM_CONTAINER/shellcont/shell").pressToolbarContextButton "&MB_EXPORT"
session.findById("wnd[0]/usr/cntlG_CUSTOM_CONTAINER/shellcont/shell").selectContextMenuItem "&XXL"
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "C:\Users\seda.scm31\Desktop\VALIDAÇÃO DE PEDIDOS\PUMI\Bases Condição de Pagamento\Division 50 - HHP"
...
session.findById("wnd[0]/usr/cntlG_CUSTOM_CONTAINER/shellcont/shell").pressToolbarContextButton "&MB_EXPORT"
session.findById("wnd[0]/usr/cntlG_CUSTOM_CONTAINER/shellcont/shell").selectContextMenuItem "&XXL"
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "C:\Users\seda.scm31\Desktop\VALIDAÇÃO DE PEDIDOS\PUMI\Bases Condição de Pagamento\Division 61 - HME"
