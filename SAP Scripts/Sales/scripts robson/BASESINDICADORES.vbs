...
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "C:\Users\seda.scm31\Desktop\BASES\BASE CE INDICADORES"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND_CE_23_06_A.XLSX"
...
session.findById("wnd[0]/tbar[1]/btn[8]").press
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "C:\Users\seda.scm31\Desktop\BASES\BASE MX INDICADORES"
