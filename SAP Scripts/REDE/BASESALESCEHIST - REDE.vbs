...
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 22 09 A.xlsx"
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 22 09 B.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 22
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 22 10 A.xlsx"
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 22 10 B.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 22 11 A.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 22 11 B.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 22 12 A.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 22 12 B.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 23 01 A.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 23 01 B.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 23 02 A.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 23 02 B.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 23 03 A.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 23 03 B.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 23 04 A.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 23 04 B.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 23 05 A.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 23 05 B.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 24
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\CE"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND CE 23 06 A.xlsx"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 22
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]").sendVKey 3
session.findById("wnd[0]").sendVKey 3
