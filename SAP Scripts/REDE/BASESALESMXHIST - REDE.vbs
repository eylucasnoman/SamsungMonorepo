...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\MX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND MX 23 05 A.XLSX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 19
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]/tbar[0]/btn[3]").press
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\MX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND MX 23 05 B.XLSX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 19
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]/tbar[0]/btn[3]").press
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\MX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND MX 23 05 C.XLSX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 19
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]/tbar[0]/btn[3]").press
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\MX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND MX 23 05 D.XLSX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 19
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]/tbar[0]/btn[3]").press

session.findById("wnd[0]/usr/ctxtS_BLDAT-LOW").text = "2023.06.01"
session.findById("wnd[0]/usr/ctxtS_BLDAT-HIGH").text = "2023.06.10"
session.findById("wnd[0]/usr/ctxtP_VAR").text = "SCM CE/"
session.findById("wnd[0]/usr/ctxtP_VAR").setFocus
session.findById("wnd[0]/usr/ctxtP_VAR").caretPosition = 7
session.findById("wnd[0]/tbar[1]/btn[8]").press
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\MX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND MX 23 06 A.XLSX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 19
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]/tbar[0]/btn[3]").press

session.findById("wnd[0]/usr/ctxtS_BLDAT-LOW").text = "2023.06.11"
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\MX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND MX 23 06 B.XLSX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 19
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]/tbar[0]/btn[3]").press

session.findById("wnd[0]/usr/ctxtS_BLDAT-LOW").text = "2023.06.16"
session.findById("wnd[0]/usr/ctxtS_BLDAT-HIGH").text = "2023.06.22"
session.findById("wnd[0]/usr/ctxtP_VAR").text = "SCM CE/"
session.findById("wnd[0]/usr/ctxtP_VAR").setFocus
session.findById("wnd[0]/usr/ctxtP_VAR").caretPosition = 7
session.findById("wnd[0]/tbar[1]/btn[8]").press
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\MX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND MX 23 06 C.XLSX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 19
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]/tbar[0]/btn[3]").press

session.findById("wnd[0]/usr/ctxtS_BLDAT-LOW").text = "2023.06.23"
...
session.findById("wnd[0]").sendVKey 34
session.findById("wnd[1]/usr/ctxtDY_PATH").text = "W:\1_SALES_STATUS_HHP\BASES SAP\MX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "OUTBOUND MX 23 06 D.XLSX"
session.findById("wnd[1]/usr/ctxtDY_FILENAME").caretPosition = 19
session.findById("wnd[1]/tbar[0]/btn[11]").press
session.findById("wnd[0]/tbar[0]/btn[3]").press
session.findById("wnd[0]/tbar[0]/btn[3]").press
